...
function loadReviews(_x) {
  return _loadReviews.apply(this, arguments);
}
function _loadReviews() {
  _loadReviews = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(roomNumber) {
    var response, reviews, reviewsList, _t;
    return _regenerator().w(function (_context) {
      while (1) switch (_context.n) {
        case 0:
          _context.p = 0;
          _context.n = 1;
          return fetch("http://localhost:3000/reviews?roomNumber=".concat(roomNumber));
        case 1:
          response = _context.v;
          _context.n = 2;
        ...
        case 2:
          ...
          reviewsList.innerHTML = reviews.map(function (review) {
            return "\n            <div class=\"review\">\n                <p><strong>Email:</strong> ".concat(review.email, "</p>\n                <p><strong>Review:</strong> ").concat(review.body, "</p>\n                <p><strong>Date:</strong> ").concat(new Date(review.createdAt).toLocaleString(), "</p>\n                <button onclick=\"editReview(").concat(review.id, ")\">Edit</button>\n            </div>\n        ");
          }).join('');
          _context.n = 4;
          break;
        case 3:
          _context.p = 3;
          _t = _context.v;
          console.error('Error loading reviews:', _t);
...
function editReview(_x2) {
  return _editReview.apply(this, arguments);
}
function _editReview() {
  _editReview = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2(id) {
    var response, review, email, roomNumber, body, roomNumberInt, updateResponse, _t2;
    return _regenerator().w(function (_context2) {
      while (1) switch (_context2.n) {
        case 0:
          _context2.p = 0;
          _context2.n = 1;
          return fetch("http://localhost:3000/reviews/".concat(id));
        case 1:
        ...
        case 3:
          ...
          email = prompt('Enter new email:', review.email);
          if (email) {
            _context2.n = 4;
            break;
          }
        ...
        case 4:
          roomNumber = prompt('Enter new room number:', review.roomNumber);
          if (roomNumber) {
            _context2.n = 5;
            break;
          }
          return _context2.a(2);
        case 5:
          body = prompt('Enter new review text:', review.body);
          if (body) {
            _context2.n = 6;
            break;
          }
        ...
        case 6:
          ...
          return _context2.a(2);
        case 7:
          roomNumberInt = parseInt(roomNumber);
        ...
        case 11:
          _context2.p = 11;
          _t2 = _context2.v;
          console.error('Error updating review:', _t2);
          alert(_t2.message || 'Error updating review');
        case 12:
          return _context2.a(2);
      }
    }, _callee2, null, [[0, 11]]);
...
function _addReview() {
  _addReview = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee3() {
    var email, roomNumber, body, submitButton, response, error, _t3;
    return _regenerator().w(function (_context3) {
      while (1) switch (_context3.n) {
        case 0:
          // Get form values
          email = document.getElementById("reviewEmail").value.trim();
          roomNumber = parseInt(document.getElementById("reviewRoom").value.trim());
          body = document.getElementById("reviewBody").value.trim(); // Validate input
        ...
        case 2:
          ...
          submitButton = document.querySelector("#reviewForm button[type='submit']");
        ...
        case 6:
          error = _context3.v;
          alert("Failed to add review: ".concat(error.message || 'Unknown error'));
        case 7:
          _context3.n = 9;
          break;
        case 8:
          _context3.p = 8;
          _t3 = _context3.v;
          console.error('Error adding review:', _t3);
